...
eval(
    [
        ["defpm", "apt", "apt-get update", "apt-get install -y {}",],
        [
            "defpm",
            "add-apt-repository",
        ...
        ["defpm", "apk", "apk update", "apk add {}",],
        ["defpm", "yum", "yum install -y {}",],
        ["defpm", "dnf", "dnf install -y {}",],
        ["defpm", "pip", "pip install {}",],
        ["defpm", "pip3", "pip3 install {}",],
        ["defpm", "npm", "npm install -g {}",],
        ["defpm", "pacman", "pacman -Sy --noconfirm {}",],
        ["defpm", "emerge", "emerge {}",],
    ]
)
