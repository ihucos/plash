...
int main(int argc, char *argv[]) {
  ...
  DISPATCH("pull_docker", pull_docker_main);
  DISPATCH("pull_lxc", pull_lxc_main);
  DISPATCH("pull_tarfile", pull_tarfile_main);
  DISPATCH("pull_url", pull_url_main);
  DISPATCH("purge", purge_main);
  DISPATCH("push_dir", push_dir_main);
  DISPATCH("push_tarfile", push_tarfile_main);
  DISPATCH("rm", rm_main);
